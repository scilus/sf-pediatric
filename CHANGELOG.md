...
- Update to nf-core template `4.1.0` ([#129](https://github.com/scilus/sf-pediatric/pull/129))
...
- B-values thresholds for DTI and fODF fit are now checked at pipeline initialisation to prevent later less informative errors.
